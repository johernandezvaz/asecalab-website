export const coursesData = [
    {
      ...
      },
      {
        ...
        description: " 370	Propiedades Mecánicas de tensión para productos de forja, funcidión de aluminio y aleaciones de magnesio.",
      },
      {
        title: "ASTM E 646",
      ...
      {
        title: 'ASTM D143',
        description: "Métodos de Ensayos Mecánico para Maderas",
      },
]